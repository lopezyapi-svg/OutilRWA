...
content = open('c:/OutilRWA/frontend/lib/modules/risque_operationnel/widgets/ro_import_pertes_dialog.dart', 'r', encoding='utf-8').read()
...
open('c:/OutilRWA/frontend/lib/modules/risque_operationnel/widgets/ro_import_pertes_dialog.dart', 'w', encoding='utf-8').write(content)
print('Success ro_import_pertes_dialog.dart')
