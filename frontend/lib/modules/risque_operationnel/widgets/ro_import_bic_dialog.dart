  ...
  Widget _buildDropContent() => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              _isDragging ? 'Déposez le fichier pour lancer la lecture' : 'Déposez le fichier BIC / CCR3 ici',
              style: TextStyle(
                fontSize: 22,
            ...
            Text(
              'Chaque onglet du fichier porte le nom de l\'exercice concerné '
              '(ex : « 2024 »), donc l\'import sait toujours à quelle année '
              'appartiennent les valeurs de chaque feuille.',
            ...
            const SizedBox(height: 14),
            Text(
              'Fichier accepté: .xlsx — un onglet par exercice (nommé avec '
              'l\'année), avec les colonnes « Poste » et « Valeur ».',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'Un onglet = un exercice. Renommez l\'onglet avec l\'année '
            '(ex : « 2024 »). Dans chaque onglet, deux colonnes : « Poste », '
            '« Valeur ».',
            style: TextStyle(fontSize: 12, color: _muted, height: 1.35),
          ),
          const SizedBox(height: 12),
          _formatCheck('Nom de l\'onglet', 'L\'année de l\'exercice, ex : « 2024 »', true),
          _formatCheck('Poste', 'Un des 13 libellés du formulaire BIC', true),
          _formatCheck('Valeur', 'Montant en FCFA', true),
          const SizedBox(height: 4),
          Text(
            'Astuce : une feuille unique avec une colonne « Année » par ligne '
            'reste aussi acceptée.',
            style: TextStyle(fontSize: 10.5, color: _muted, fontStyle: FontStyle.italic, height: 1.3),
          ),
          const Spacer(),
