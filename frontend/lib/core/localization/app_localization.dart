...
const Map<String, String> _englishTranslations = {
  ...
  'Module en construction': 'Module under construction',
  'Cette section sera disponible dans une prochaine version.': 'This section will be available in a future release.',
  'Expositions individuelles rapportées aux fonds propres effectifs': 'Individual exposures relative to effective own funds',
  '< 25 % des FP': '< 25% of own funds',
  '> 25 % des FP': '> 25% of own funds',
  ...
  'Limite individuelle : 25 % des fonds propres effectifs': 'Individual limit: 25% of effective own funds',
  ...
  // --- Couverture i18n élargie (FODEP, Expositions, Risque Marché,
  // panneaux DashPanel désormais traduits) ---
  '% Couverture': '% Coverage',
  '(Taux du coussin × Actifs pondérés au risque)':
      '(Buffer rate × Risk-weighted assets)',
  'Actualisation des courbes': 'Curve refresh',
  'Afficher l’interprétation de la courbe': 'Show curve interpretation',
  'Ajouter au moins un actif dans le panier.':
      'Add at least one asset to the basket.',
  'Appliquer': 'Apply',
  'Aucune série exploitable pour cette courbe.':
      'No usable series for this curve.',
  'CET1': 'CET1',
  'Capital min. requis (crédit)': 'Min. capital required (credit)',
  'Choisir le format d\'export': 'Choose the export format',
  'Choisir les colonnes à afficher': 'Choose columns to display',
  'Choisir une date': 'Choose a date',
  'Colonnes ({{count}})': 'Columns ({{count}})',
  'Colonnes affichées': 'Displayed columns',
  'Colonnes visibles': 'Visible columns',
  'Contrôle des sources effectué le': 'Source check performed on',
  'Coussin': 'Buffer',
  'Critères': 'Criteria',
  'Delta-Normale': 'Delta-Normal',
  'Données indisponibles': 'Data unavailable',
  'EAD par catégorie': 'EAD by category',
  'Echeance anterieure a l octroi': 'Maturity before disbursement',
  'Export Excel enregistre avec succes.': 'Excel export saved successfully.',
  'Export PDF enregistre avec succes.': 'PDF export saved successfully.',
  'Exportation...': 'Exporting...',
  'Exporter en Excel': 'Export to Excel',
  'Exporter en PDF': 'Export to PDF',
  'FCEC': 'CCF',
  'Filtre': 'Filter',
  'Genere automatiquement': 'Automatically generated',
  'Interprétation de la courbe': 'Curve interpretation',
  'Mettre a jour les IDs apres suppression': 'Update IDs after deletion',
  'Montant couvert': 'Amount covered',
  'Montant positif requis': 'Positive amount required',
  'Nom de la contrepartie': 'Counterparty name',
  'Non determinee': 'Not determined',
  'Part non couverte': 'Uncovered portion',
  'Pays de residence': 'Country of residence',
  'Pilier 1': 'Pillar 1',
  'Precedent': 'Previous',
  'Provisions < 20 % de l’encours': 'Provisions < 20% of outstanding amount',
  'Provisions ≥ 20 % de l’encours': 'Provisions ≥ 20% of outstanding amount',
  'Provisions': 'Provisions',
  'Précédent': 'Previous',
  'RWA Crédit × 9%': 'Credit RWA × 9%',
  'Rechercher par': 'Search by',
  'Rechercher un titre...': 'Search for a security...',
  'Rechercher émetteur': 'Search issuer',
  'Réduire': 'Collapse',
  'Réinitialiser': 'Reset',
  'Selectionner le pays du garant': 'Select the guarantor country',
  'Selectionner un pays': 'Select a country',
  'Selectionner une date': 'Select a date',
  'Seuil réglementaire : {{seuil}} %': 'Regulatory threshold: {{seuil}} %',
  'Situation': 'Status',
  'Suivant': 'Next',
  'Supprimer le titre ?': 'Delete the security?',
  'Taux du coussin': 'Buffer rate',
  'Tier 1': 'Tier 1',
  'Titre ajouté.': 'Security added.',
  'Titre mis à jour.': 'Security updated.',
  'Titre supprimé.': 'Security deleted.',
  'Toujours visible': 'Always visible',
  'Tout afficher': 'Show all',
  'Type de CRM': 'CRM type',
  'Valeur de la sûreté': 'Collateral value',
  ...
  'PROVISIONS': 'PROVISIONS',
  'Provisions totales sur NPL': 'Total provisions on NPL',
  'Taux de couverture': 'Coverage ratio',
  'Provisions / Encours total': 'Provisions / Total outstanding',
  '1 à 30 j': '1 to 30 days',
  '31 à 90 j': '31 to 90 days',
  '91 à 180 j': '91 to 180 days',
  'Plus de 180 j': 'Over 180 days',
  'Zones': 'Zones',
  'capital consommé': 'capital consumed',
  'EAD total': 'Total EAD',
  'base exposée': 'exposed base',
  'RW moyen': 'Avg. RW',
  'pondération moyenne': 'average weighting',
  'Plus fort contributeur': 'Largest contributor',
  'Défauts': 'Defaults',
  'expositions marquées': 'flagged exposures',
  'Part portefeuille': 'Portfolio share',
  'Part RWA': 'RWA share',
  'Encours': 'Outstanding',
  'Encours NPL :  ': 'NPL outstanding:  ',
  'Provisions totales :  ': 'Total provisions:  ',
  'Indicateurs NPL et Provisions': 'NPL and provisions indicators',
  'Suivi du nombre de jours impayés': 'Days past due tracking',
  'Nombre NPL :  ': 'NPL count:  ',
  'Top 5 des plus grandes expositions NPL (brut)':
      'Top 5 largest NPL exposures (gross)',
  'Encours brut': 'Gross outstanding',
  'Provision': 'Provision',
  'Taux couv.': 'Cov. ratio',
  'Voir toutes les expositions NPL': 'View all NPL exposures',
  'SIGNAL': 'SIGNAL',
  'RISQUE': 'RISK',
  'IMPACT': 'IMPACT',
  'DÉCISION': 'DECISION',
  ...
  // --- Risque Opérationnel ---
  '+90j UEMOA': '+90d UEMOA',
  'Ajouter le premier risque': 'Add the first risk',
  'Aller à la Saisie': 'Go to Data Entry',
  'Art. 315–321 CRR3 (Règlement UE 2019/876 adapté BCEAO)':
      'Art. 315–321 CRR3 (EU Regulation 2019/876 adapted BCEAO)',
  'Art. 315–321 CRR3 • PNB saisi directement':
      'Art. 315–321 CRR3 • Net banking income entered directly',
  'Aucun KRI': 'No KRI',
  'Aucun PNB saisi': 'No net banking income entered',
  'Aucun contrôle enregistré.': 'No control recorded.',
  'Aucun enregistrement disponible': 'No record available',
  'Aucun incident dans le registre.': 'No incident in the register.',
  'Aucun incident enregistré.': 'No incident recorded.',
  'Aucun incident': 'No incident',
  'Aucun plan correspondant au filtre.': 'No plan matching the filter.',
  'Aucun risque enregistré.': 'No risk recorded.',
  'Aucune donnée saisie': 'No data entered',
  'Aucune donnée': 'No data',
  'Aucune donnée.': 'No data.',
  'BI total : ': 'Total BI: ',
  'BIC / CRR3': 'BIC / CRR3',
  'Bloc': 'Block',
  'Capital minimum (Art. 89)': 'Minimum capital (Art. 89)',
  'Cartographie des risques opérationnels': 'Operational risk mapping',
  'Cause racine identifiée': 'Root cause identified',
  'Cause racine': 'Root cause',
  'Coefficients et seuils BIC': 'BIC coefficients and thresholds',
  'Commentaire (optionnel)': 'Comment (optional)',
  'Composante': 'Component',
  'Composition du Business Indicator (BI)':
      'Composition of the Business Indicator (BI)',
  'Confidentiel - Usage interne': 'Confidential - Internal use',
  'Confirmation': 'Confirmation',
  'Confirmer': 'Confirm',
  'Contrôles non conformes': 'Non-compliant controls',
  'Date de mesure': 'Measurement date',
  'Dispositif de contrôle opérationnel': 'Operational control framework',
  'Données sauvegardées - résultats mis à jour':
      'Data saved - results updated',
  'Déclarer un incident': 'Report an incident',
  'Délai 90j dépassé': '90-day deadline exceeded',
  'En retard': 'Overdue',
  'Estimation BIA (Art. 89) - indicative':
      'BIA estimate (Art. 89) - indicative',
  'Exigence de fonds propres (OFR) BIA':
      'Own funds requirement (OFR) BIA',
  'Exigence de fonds propres (OFR) CRR3':
      'Own funds requirement (OFR) CRR3',
  'Export Excel réussi': 'Excel export successful',
  'Export PDF réussi': 'PDF export successful',
  'Exporter le registre': 'Export the register',
  'Historique Événements - Risque Opérationnel':
      'Event history - Operational Risk',
  'IMPACT →': 'IMPACT →',
  'INDICATEURS CLÉS DE RISQUE · ART. 313 BCEAO/UMOA':
      'KEY RISK INDICATORS · ART. 313 BCEAO/UMOA',
  'Importez un fichier Excel BIC/CCR3 pour voir les données ici.':
      'Import a BIC/CCR3 Excel file to see data here.',
  'Impossible de charger les données BIC COREP':
      'Unable to load BIC COREP data',
  'Impossible de charger les données BIC': 'Unable to load BIC data',
  'Incidents (mois)': 'Incidents (month)',
  'Indicateur': 'Indicator',
  'Journal non modifiable - conservation 7 ans (UMOA)':
      'Immutable log - retained 7 years (UMOA)',
  'KRI hors seuil': 'KRI out of threshold',
  'La saisie se fait depuis la section UEMOA.':
      'Data entry is done from the UEMOA section.',
  'Ligne de métier': 'Business line',
  'Mise à jour conforme Art. 313.b UMOA': 'Update compliant with Art. 313.b UMOA',
  'Modifier': 'Edit',
  'Montants en FCFA · valeurs absolues (positif = produit, négatif = charge pour FC)':
      'Amounts in FCFA · absolute values (positive = income, negative = expense for FC)',
  'Montants en FCFA': 'Amounts in FCFA',
  'Multiplicateur REA': 'RWA multiplier',
  'Niveau critique': 'Critical level',
  'Niveau de pilotage': 'Oversight level',
  'Niveau faible': 'Low level',
  'Niveau élevé': 'High level',
  'Non clôturés': 'Not closed',
  'Nouveau contrôle': 'New control',
  'Nouveau plan': 'New plan',
  'Nouveau risque': 'New risk',
  'OFR BIA': 'OFR BIA',
  'OFR CRR3': 'OFR CRR3',
  'PNB annuel': 'Annual net banking income',
  'PNB sauvegardé - résultats mis à jour':
      'Net banking income saved - results updated',
  'PROBABILITÉ ↑': 'PROBABILITY ↑',
  'Paramètres mis à jour': 'Parameters updated',
  'Perte brute totale': 'Total gross loss',
  'Perte brute': 'Gross loss',
  'Perte moy. / incident': 'Avg. loss / incident',
  'Perte nette totale': 'Total net loss',
  'Perte nette': 'Net loss',
  'Perte récupérée': 'Recovered loss',
  'Pertes enregistrées': 'Losses recorded',
  'Pertes nettes (mois)': 'Net losses (month)',
  'Pertes par ligne de métier': 'Losses by business line',
  'Pertes significatives': 'Significant losses',
  'Position BI actuelle': 'Current BI position',
  'Position Tranche BIC': 'BIC bucket position',
  'Position du BI dans la grille de tranches':
      'Position of the BI in the bucket grid',
  'P×I': 'P×I',
  'REGISTRE DES PERTES OPÉRATIONNELLES': 'OPERATIONAL LOSSES REGISTER',
  'RWA opérationnel': 'Operational RWA',
  'Ratio cible': 'Target ratio',
  'Ratio résistance': 'Resistance ratio',
  'Rechercher une perte...': 'Search a loss...',
  'Registre des Pertes - Risque Opérationnel BCEAO':
      'Losses register - BCEAO Operational Risk',
  'Risque opérationnel - Art. 313 BCEAO': 'Operational risk - Art. 313 BCEAO',
  'Risques cartographiés': 'Mapped risks',
  'Résiduel ': 'Residual ',
  'Saisie des données KRI': 'KRI data entry',
  'Saisir données KRI': 'Enter KRI data',
  'Saisissez au moins un paramètre\npour lancer la simulation':
      'Enter at least one parameter\nto run the simulation',
  'Score global': 'Overall score',
  'Seuil plafond ILDC': 'ILDC ceiling threshold',
  'Seuil tranche 1→2': 'Bucket 1→2 threshold',
  'Seuil tranche 2→3': 'Bucket 2→3 threshold',
  'Seuils en FCFA  (Option A recommandée : parité EUR/FCFA fixe = 655,957)':
      'Thresholds in FCFA (Option A recommended: fixed EUR/FCFA parity = 655.957)',
  'Suivi et traçabilité des actions correctives':
      'Tracking and traceability of corrective actions',
  'Survolez une cellule pour voir les risques':
      'Hover over a cell to see the risks',
  'Sélectionner…': 'Select…',
  'Sélectionnez le format du fichier à générer.':
      'Select the format of the file to generate.',
  'Taux EUR→FCFA': 'EUR→FCFA rate',
  'Taux de récupération': 'Recovery rate',
  'Taux global BCEAO': 'Overall BCEAO rate',
  'Taux tranche 1': 'Bucket 1 rate',
  'Taux tranche 2': 'Bucket 2 rate',
  'Taux tranche 3': 'Bucket 3 rate',
  'Top 5 - Incidents par perte nette': 'Top 5 - Incidents by net loss',
  'Tranche 1  (≤ S1)': 'Bucket 1  (≤ S1)',
  'Tranche 2  (S1–S2)': 'Bucket 2  (S1–S2)',
  'Tranche 3  (> S2)': 'Bucket 3  (> S2)',
  'Tranche BIC': 'BIC bucket',
  'Tranche maximale atteinte': 'Maximum bucket reached',
  'Valeur KRI enregistrée.': 'KRI value recorded.',
  'Valeur KRI invalide.': 'Invalid KRI value.',
  'Écart': 'Variance',
  'Évolution N-1': 'Change vs. prior year',

  // --- Risque de Marché ---
  '95e percentile': '95th percentile',
  '99e percentile': '99th percentile',
  'Achats à terme': 'Forward purchases',
  'Actifs': 'Assets',
  'Afficher les alertes de risque': 'Show risk alerts',
  'Ajouter un titre': 'Add a security',
  'Amortissement moyen': 'Average amortization',
  'Amortissement projeté': 'Projected amortization',
  'Aucune donnée chargée': 'No data loaded',
  'Aucune donnée historique chargée': 'No historical data loaded',
  'Aucune donnée obligataire chargée': 'No bond data loaded',
  'Aucune donnée trouvée dans le fichier Excel':
      'No data found in the Excel file',
  'Aucune simulation disponible': 'No simulation available',
  'Bêta Pondéré': 'Weighted Beta',
  'CRD actuel': 'Current outstanding principal',
  'CRD fin de période': 'Outstanding principal at period end',
  'Capital Prudentiel': 'Prudential Capital',
  'Chargement de la VaR': 'Loading VaR',
  'Chargement des indicateurs': 'Loading indicators',
  'Chargement du dashboard': 'Loading dashboard',
  'Chargement du tableau': 'Loading table',
  'Contribution Change': 'FX Contribution',
  'Contribution Risque Marché': 'Market Risk Contribution',
  'Convexité pondérée': 'Weighted convexity',
  'Convexité': 'Convexity',
  'Coupon par maturité': 'Coupon by maturity',
  'Courbe des taux': 'Yield curve',
  'Date d’analyse': 'Analysis date',
  'Devise (ex: USD)': 'Currency (e.g. USD)',
  'Données insuffisantes': 'Insufficient data',
  'Défaut': 'Default',
  'Détail complet des lignes distributrices': 'Full detail of distributing lines',
  'Détail complet des positions classées par valeur de marché':
      'Full detail of positions ranked by market value',
  'Détail complet des émetteurs': 'Full detail of issuers',
  'Détail complet': 'Full detail',
  'Encours par tranche de maturité résiduelle':
      'Outstanding by residual maturity bucket',
  'Encours total': 'Total outstanding',
  'Essentiel': 'Essential',
  'Exigence FP Actions': 'Equity capital requirement',
  'Exigence FP Change': 'FX capital requirement',
  'Exigence FP Marché': 'Market capital requirement',
  'Exigence FP Taux': 'Interest rate capital requirement',
  'Exigence globale convertie en risques pondérés':
      'Overall requirement converted into risk-weighted assets',
  'Exigence liée aux variations du marché des taux':
      'Requirement related to interest rate market movements',
  'Exigence liée à la qualité de chaque émetteur':
      'Requirement related to each issuer\'s credit quality',
  'Export Actions enregistré avec succès.': 'Equities export saved successfully.',
  'Export Obligations enregistré avec succès.':
      'Bonds export saved successfully.',
  'Exporter le tableau de bord Actions (Excel)':
      'Export the Equities dashboard (Excel)',
  'Exporter le tableau de bord Obligations (Excel)':
      'Export the Bonds dashboard (Excel)',
  'Exposition Totale': 'Total Exposure',
  'Exposition par devise': 'Exposure by currency',
  'JJ/MM/AAAA': 'DD/MM/YYYY',
  'Maturité (en mois)': 'Maturity (in months)',
  'Maturité et portage': 'Maturity and carry',
  'Maturités': 'Maturities',
  'Modifier le titre': 'Edit the security',
  'Moins-values latentes': 'Unrealized losses',
  'Nous préparons la vue du portefeuille.': 'Preparing the portfolio view.',
  'Nous préparons les chiffres du portefeuille.':
      'Preparing the portfolio figures.',
  'Nous préparons les titres à afficher.': 'Preparing the securities to display.',
  'POSITIONS LONGUES': 'LONG POSITIONS',
  'Part du risque de taux dans le RWA de marché':
      'Share of interest rate risk in market RWA',
  'Passifs': 'Liabilities',
  'Perte sur choc de +100 pb': 'Loss on a +100 bp shock',
  'Plus et moins-values latentes': 'Unrealized gains and losses',
  'Plus-values latentes': 'Unrealized gains',
  'Plus/Moins-value Latente': 'Unrealized Gain/Loss',
  'Poids du premier émetteur': 'Weight of the largest issuer',
  'Portefeuille Actions': 'Equity portfolio',
  'Position Nette Globale': 'Overall Net Position',
  'Position Nette': 'Net Position',
  'Position brute × 9 %': 'Gross position × 9%',
  'Position brute': 'Gross position',
  'Position nette': 'Net position',
  'Positions longues moins positions courtes': 'Long positions minus short positions',
  'Principaux émetteurs': 'Main issuers',
  'Profil bêta et rendement par émetteur': 'Beta and return profile by issuer',
  'Périmètre comptable': 'Accounting scope',
  'RWA Actions': 'Equity RWA',
  'RWA Change': 'FX RWA',
  'RWA Marché Total': 'Total Market RWA',
  'RWA Taux': 'Interest Rate RWA',
  'Rendement Espéré': 'Expected Return',
  'Revenu de dividendes attendu': 'Expected dividend income',
  'Risque Général': 'General Risk',
  'Risque Spécifique': 'Specific Risk',
  'Risque de change sur la position nette globale':
      'FX risk on the overall net position',
  'Risque général (9%)': 'General risk (9%)',
  'Risque spécifique (9%)': 'Specific risk (9%)',
  'Risque spécifique + risque général': 'Specific risk + general risk',
  'Risque spécifique et général sur les actions':
      'Specific and general risk on equities',
  'Risques Pondérés (RWA)': 'Risk-Weighted Assets (RWA)',
  'Rythme': 'Pace',
  'Scénarios simulés et pertes extrêmes': 'Simulated scenarios and extreme losses',
  'Sens': 'Direction',
  'Somme des exigences de fonds propres': 'Sum of capital requirements',
  'Somme des valeurs absolues des positions': 'Sum of the absolute values of positions',
  'Structure des maturités': 'Maturity structure',
  'Structure du RWA Marché': 'Market RWA structure',
  'Supprimer la position': 'Delete the position',
  'Supprimer le titre': 'Delete the security',
  'Sélectionner...': 'Select...',
  'Top 5 par poids de marché': 'Top 5 by market weight',
  'Total Courtes': 'Total Short',
  'Total Longues': 'Total Long',
  'Tout': 'All',
  'Valeur de marché convertie au taux courant':
      'Market value converted at the current rate',
  'Ventes à terme': 'Forward sales',
  'Voir tout': 'View all',
  'Volatilité Annualisée': 'Annualized Volatility',
  '|Position nette| × 9 %': '|Net position| × 9%',
  'Échelonnement du capital restant dû': 'Outstanding principal scheduling',
  'Émetteur Dominant': 'Dominant Issuer',
  'Équivalent en actifs pondérés des risques': 'Risk-weighted asset equivalent',
};
